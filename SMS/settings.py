...
ALLOWED_HOSTS = ['16.170.249.53','0.0.0.0','127.0.0.1']
...
SESSION_ENGINE = "django.contrib.sessions.backends.db"  # You can also use "django.contrib.sessions.backends.cache" or other backends.
SESSION_COOKIE_NAME = "my_session_cookie_name"
SESSION_SAVE_EVERY_REQUEST = True  # This will save the session on each request.
