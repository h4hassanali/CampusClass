...
class CourseAllocationFormView(CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = "HU LMS | Assign Course"
        return context
...
def course_allocation_view(request):
    ...
    return render(request, 'course/course_allocation_view.html', {
        'title': "HU LMS | Course Allocations",
...
def edit_allocated_course(request, pk):
    ...
    return render(request, 'course/course_allocation_form.html', {
        'title': "HU LMS | Edit Course Allocated",
...
def course_registration(request):
    if request.method == 'POST':
        ...
        # current_semester = Semester.objects.filter(is_current_semester=True)
        ###############
        ...
        total_fourth_semester_credit = 0
        total_fifth_semester_credit = 0
        total_sixth_semester_credit = 0
        total_seventh_semester_credit = 0
        total_eighth_semester_credit = 0
        ...
        for i in courses:
            ...
            if i.semester == "Fourth":
                total_fourth_semester_credit += int(i.credit)
            if i.semester == "Fifth":
                total_fifth_semester_credit += int(i.credit)
            if i.semester == "Sixth":
                total_sixth_semester_credit += int(i.credit)
            if i.semester == "Seventh":
                total_seventh_semester_credit += int(i.credit)
            if i.semester == "Eighth":
                total_eighth_semester_credit += int(i.credit)
            ####
